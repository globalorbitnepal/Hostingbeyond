...
export function DomainTransferView({
  initialDomain = "",
  content,
  page,
  crossLinkHref,
  ...
  return (
    <>
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-white/75">
                        {price ? formatPrice(price.transfer) : ""}
                      </span>
      ...
      <section id="how-transfer" className="hb-band-purple py-12 sm:py-14">
        <div className="hb-shell relative z-10">
