  ...
  return (
    <div className="hb-story-band">
      <div className="hb-shell">
        ...
        <h2 className="font-heading mt-2 text-center text-[clamp(1.45rem,3.1vw,2.45rem)] leading-[1.15] font-extrabold tracking-[-0.045em] text-slate-950">
          {lead}{" "}
          <span className="relative inline-grid min-h-[1.2em] min-w-[10ch] justify-items-center overflow-hidden align-bottom sm:min-w-[14ch]">
            {reduceMotion || list.length < 2 ? (
              ...
              <AnimatePresence mode="wait">
                <motion.span
                  ...
                  className="bg-gradient-to-r from-[#2563eb] via-[#4f46e5] to-[#7c3aed] bg-clip-text text-transparent"
                >
                  {word}
                </motion.span>
              </AnimatePresence>
