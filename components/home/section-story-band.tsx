              ...
              <span
                className={
                  tone === "dark"
                    ...
                    : "bg-gradient-to-r from-[#2563eb] via-[#673de6] to-[#7c3aed] bg-clip-text text-transparent"
                }
              >
                {word}
              </span>
                ...
                <motion.span
                  ...
                  className={
                    tone === "dark"
                      ...
                      : "inline-block bg-gradient-to-r from-[#2563eb] via-[#673de6] to-[#7c3aed] bg-clip-text text-transparent"
                  }
                >
                  {word}
                </motion.span>
